...
1. Open `src/ontology/Ontorel-Core-edit.owl` in Protégé
2. Make the change
3. Save the file

_TextEdit_

1. Open `src/ontology/Ontorel-Core-edit.owl` in TextEdit (or Sublime, Atom, Vim, Nano)
2. Make the change
3. Save the file
...
1. According to our development philosophy, the only places that should be manually edited are:
    - `src/ontology/Ontorel-Core-edit.owl`
